...
export function attachMainHandlers() {
  ...
  // ✅ MAGAZINE PRO: one-click editorial retouch (now routed to Kontext Pro in api/generate.js)
  ...
  if (els.agreementCloseBtn) els.agreementCloseBtn.addEventListener("click", () => closeAgreementModal());
