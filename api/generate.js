...
// Фото / текст / эффекты кожи / мимика + dark-demon
...
const STYLE_PREFIX = {
  ...
  classic:
    "classical old master portrait, realism, warm tones, detailed skin",

  // 🔥 Новый стиль — dark-demon
  "dark-demon":
    "dark fantasy portrait, dramatic moody lighting, high contrast, subtle demonic elements like glowing eyes, dark aura or small horns, detailed realistic face, cinematic horror atmosphere but no blood or gore",
...
const EFFECT_PROMPTS = {
  ...
  "smooth-skin":
    "smooth flawless skin, even skin tone, subtle beauty lighting",
