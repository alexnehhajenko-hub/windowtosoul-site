...
const GREETING_PROMPTS = {
  ...
  // ✅ NEW: props / costumes (no text overlay)
  "devil-eyes":
...
export default async function handler(req, res) {
  ...
  try {
    ...
    const promptParts = [
      ...
      greetingPrompt ? ("MINIMAL EDIT: if greeting/prop is selected, apply ONLY that prop/atmosphere without changing the person's face. " + greetingPrompt) : "",
      userPrompt,
      IDENTITY_PROMPT,
      UI_CLEANUP_TAIL,
      SAFETY_TAIL
